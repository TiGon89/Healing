...
def cadastro_medico(request):
    ...
    if request.method == "GET":
        ...
        #TODO: Validar todos os campos - Feito
        if not crm or not nome or not cep or not rua or not bairro or not numero or not cim or not rg or not foto or not especialidade or not descricao or not valor_consulta:
            messages.add_message(request, constants.WARNING, 'Necessario preencher todos os campos.')
...
def abrir_horario(request):
    ...
    if request.method == "GET":
        ...
        if not data:
            messages.add_message(request, constants.WARNING, 'Data e horário, devem ser preenchida.')
            return redirect('/medicos/abrir_horario')
